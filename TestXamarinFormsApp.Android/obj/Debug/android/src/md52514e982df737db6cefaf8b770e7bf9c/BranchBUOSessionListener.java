...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BranchXamarinSDK.Droid.BranchBUOSessionListener, Branch-Xamarin-SDK.Droid", BranchBUOSessionListener.class, __md_methods);
	}


	public BranchBUOSessionListener ()
	{
		super ();
		if (getClass () == BranchBUOSessionListener.class)
			mono.android.TypeManager.Activate ("BranchXamarinSDK.Droid.BranchBUOSessionListener, Branch-Xamarin-SDK.Droid", "", this, new java.lang.Object[] {  });
	}
