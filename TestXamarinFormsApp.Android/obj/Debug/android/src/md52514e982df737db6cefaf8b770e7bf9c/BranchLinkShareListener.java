...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BranchXamarinSDK.Droid.BranchLinkShareListener, Branch-Xamarin-SDK.Droid", BranchLinkShareListener.class, __md_methods);
	}


	public BranchLinkShareListener ()
	{
		super ();
		if (getClass () == BranchLinkShareListener.class)
			mono.android.TypeManager.Activate ("BranchXamarinSDK.Droid.BranchLinkShareListener, Branch-Xamarin-SDK.Droid", "", this, new java.lang.Object[] {  });
	}
