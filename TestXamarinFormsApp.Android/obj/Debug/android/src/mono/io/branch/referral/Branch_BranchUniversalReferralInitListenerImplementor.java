...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IO.Branch.Referral.AndroidNativeBranch+IBranchUniversalReferralInitListenerImplementor, Branch-Xamarin-Lib.Droid", Branch_BranchUniversalReferralInitListenerImplementor.class, __md_methods);
	}


	public Branch_BranchUniversalReferralInitListenerImplementor ()
	{
		super ();
		if (getClass () == Branch_BranchUniversalReferralInitListenerImplementor.class)
			mono.android.TypeManager.Activate ("IO.Branch.Referral.AndroidNativeBranch+IBranchUniversalReferralInitListenerImplementor, Branch-Xamarin-Lib.Droid", "", this, new java.lang.Object[] {  });
	}
