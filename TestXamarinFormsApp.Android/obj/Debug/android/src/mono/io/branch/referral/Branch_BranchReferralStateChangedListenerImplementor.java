...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IO.Branch.Referral.AndroidNativeBranch+IBranchReferralStateChangedListenerImplementor, Branch-Xamarin-Lib.Droid", Branch_BranchReferralStateChangedListenerImplementor.class, __md_methods);
	}


	public Branch_BranchReferralStateChangedListenerImplementor ()
	{
		super ();
		if (getClass () == Branch_BranchReferralStateChangedListenerImplementor.class)
			mono.android.TypeManager.Activate ("IO.Branch.Referral.AndroidNativeBranch+IBranchReferralStateChangedListenerImplementor, Branch-Xamarin-Lib.Droid", "", this, new java.lang.Object[] {  });
	}
