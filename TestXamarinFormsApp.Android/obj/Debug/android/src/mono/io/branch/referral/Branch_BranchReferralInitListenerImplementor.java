...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IO.Branch.Referral.AndroidNativeBranch+IBranchReferralInitListenerImplementor, Branch-Xamarin-Lib.Droid", Branch_BranchReferralInitListenerImplementor.class, __md_methods);
	}


	public Branch_BranchReferralInitListenerImplementor ()
	{
		super ();
		if (getClass () == Branch_BranchReferralInitListenerImplementor.class)
			mono.android.TypeManager.Activate ("IO.Branch.Referral.AndroidNativeBranch+IBranchReferralInitListenerImplementor, Branch-Xamarin-Lib.Droid", "", this, new java.lang.Object[] {  });
	}
