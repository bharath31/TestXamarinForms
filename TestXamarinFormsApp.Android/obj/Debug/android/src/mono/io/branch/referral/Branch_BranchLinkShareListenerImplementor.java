...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IO.Branch.Referral.AndroidNativeBranch+IBranchLinkShareListenerImplementor, Branch-Xamarin-Lib.Droid", Branch_BranchLinkShareListenerImplementor.class, __md_methods);
	}


	public Branch_BranchLinkShareListenerImplementor ()
	{
		super ();
		if (getClass () == Branch_BranchLinkShareListenerImplementor.class)
			mono.android.TypeManager.Activate ("IO.Branch.Referral.AndroidNativeBranch+IBranchLinkShareListenerImplementor, Branch-Xamarin-Lib.Droid", "", this, new java.lang.Object[] {  });
	}
