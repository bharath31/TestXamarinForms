...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IO.Branch.Referral.AndroidNativeBranch+IBranchLinkCreateListenerImplementor, Branch-Xamarin-Lib.Droid", Branch_BranchLinkCreateListenerImplementor.class, __md_methods);
	}


	public Branch_BranchLinkCreateListenerImplementor ()
	{
		super ();
		if (getClass () == Branch_BranchLinkCreateListenerImplementor.class)
			mono.android.TypeManager.Activate ("IO.Branch.Referral.AndroidNativeBranch+IBranchLinkCreateListenerImplementor, Branch-Xamarin-Lib.Droid", "", this, new java.lang.Object[] {  });
	}
