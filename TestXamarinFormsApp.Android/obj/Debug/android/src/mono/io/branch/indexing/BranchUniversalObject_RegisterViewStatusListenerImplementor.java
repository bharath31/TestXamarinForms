...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IO.Branch.Indexing.BranchUniversalObject+IRegisterViewStatusListenerImplementor, Branch-Xamarin-Lib.Droid", BranchUniversalObject_RegisterViewStatusListenerImplementor.class, __md_methods);
	}


	public BranchUniversalObject_RegisterViewStatusListenerImplementor ()
	{
		super ();
		if (getClass () == BranchUniversalObject_RegisterViewStatusListenerImplementor.class)
			mono.android.TypeManager.Activate ("IO.Branch.Indexing.BranchUniversalObject+IRegisterViewStatusListenerImplementor, Branch-Xamarin-Lib.Droid", "", this, new java.lang.Object[] {  });
	}
