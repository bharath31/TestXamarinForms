...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IO.Branch.Referral.AndroidNativeBranch+IBranchListResponseListenerImplementor, Branch-Xamarin-Lib.Droid", Branch_BranchListResponseListenerImplementor.class, __md_methods);
	}
	...
	public Branch_BranchListResponseListenerImplementor ()
	{
		...
		if (getClass () == Branch_BranchListResponseListenerImplementor.class)
			mono.android.TypeManager.Activate ("IO.Branch.Referral.AndroidNativeBranch+IBranchListResponseListenerImplementor, Branch-Xamarin-Lib.Droid", "", this, new java.lang.Object[] {  });
	}
