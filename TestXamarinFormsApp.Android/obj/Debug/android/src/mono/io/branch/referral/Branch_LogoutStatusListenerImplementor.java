...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IO.Branch.Referral.AndroidNativeBranch+ILogoutStatusListenerImplementor, Branch-Xamarin-Lib.Droid", Branch_LogoutStatusListenerImplementor.class, __md_methods);
	}


	public Branch_LogoutStatusListenerImplementor ()
	{
		super ();
		if (getClass () == Branch_LogoutStatusListenerImplementor.class)
			mono.android.TypeManager.Activate ("IO.Branch.Referral.AndroidNativeBranch+ILogoutStatusListenerImplementor, Branch-Xamarin-Lib.Droid", "", this, new java.lang.Object[] {  });
	}
